        ...
        statics: {
            methods: {
                ...
                ReadAllText: function(path) {
                    ...
                    return System.IO.File.InternalReadAllText(
                        path,
                ...
                InternalReadAllText: function(path, encoding, checkHost) {
                    var sr = new System.IO.StreamReader.$ctor12(
                        path,
                        encoding,
                        true,
                        System.IO.StreamReader.DefaultBufferSize,
                        checkHost
                    );
                    try {
                        return sr.ReadToEnd();
                ...
                InternalReadAllBytes: function(path, checkHost) {
                    ...
                    try {
                        ...
                        if (fileLength.gt(System.Int64(2147483647))) {
                            throw new System.IO.IOException.$ctor1(
                ...
                ReadAllLines: function(path) {
                    ...
                    return System.IO.File.InternalReadAllLines(
                        path,
                        System.Text.Encoding.UTF8
                    );
                },
                ...
                InternalReadAllLines: function(path, encoding) {
                    var line;
                    var lines = new (System.Collections.Generic.List$1(
                        System.String
                    ).ctor)();
                ...
                ReadLines: function(path) {
                    ...
                    return System.IO.ReadLinesIterator.CreateIterator(
                        path,
                        System.Text.Encoding.UTF8
                    );
                },
