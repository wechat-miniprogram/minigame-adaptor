...
目前我们探索出开发流程，经过不同游戏的验证。开发者在在Unity编辑器导出 "美术资源"，然后直接在小游戏平台上，使用 js/ts 在`微信小游戏性能优化方案`的基础上开发游戏逻辑。该方案有比较好的 Unity 兼容性，兼容至 Unity3D 5.5+。该方案详情可见 [该文档](./docs/basic/flow.md)。
