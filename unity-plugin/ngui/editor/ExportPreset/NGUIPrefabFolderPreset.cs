...
namespace WeChat
{
    ...
    // 导出选中的prefab
    [InitializeOnLoad]
    [DeclarePreset("ngui-prefabfolder", typeof(NGUIExportConfig))]
    internal class NGUIPrefabFolderPreset : ExportPreset
    {
        static NGUIPrefabFolderPreset()
        {
            ExportPreset.registerExportPreset("ngui-prefabfolder", new NGUIPrefabFolderPreset());
        }
        public NGUIPrefabFolderPreset(): base()
        {
            is2d = true;
        }
        public override string GetChineseName()
        {
            return "该目录下的所有ngui-prefab";
        }
