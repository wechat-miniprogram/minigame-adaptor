...
Shader "WXBBShader/ClearCoat" {
	...
	SubShader{
		...
		Pass {
			...
			CGPROGRAM
			#pragma multi_compile CLEAR_COAT_SHADINGMODEL
			...
			fixed4 frag(v2f i) : SV_Target {
				...
				fixed3 color = LightingBxDF(surfaceData, pixelInput, _LightColor0.xyz, i.lightDirWS);
		...
		// 		fixed3 color = LightingBxDFNoGI(surfaceData, pixelInput, _LightColor0.xyz * light.attenuation, light.direction);
