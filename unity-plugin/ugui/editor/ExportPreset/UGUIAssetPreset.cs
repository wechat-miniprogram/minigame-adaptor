...
{
    [InitializeOnLoad]
    [DeclarePreset("ugui-asset", typeof(UGUIExportConfig))]
    internal class UGUIAssetExportPreset : ExportPreset
    {
        static UGUIAssetExportPreset()
        {
            ExportPreset.registerExportPreset("ugui-asset", new UGUIAssetExportPreset());
        }

        public UGUIAssetExportPreset() : base()
        {
        }

        public override string GetChineseName()
        {
            return "选中的ugui-prefab资源";
        }
