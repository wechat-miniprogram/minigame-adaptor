...
namespace WeChat {
    ...
    public class ScriptExportModule : ExportPluginModule {
        ...
        public ScriptExportModule() : base("script", "0.7.0") { // 注意这个0.7.0千万不要改掉。构建时会有脚本去覆盖
        ...
        [MenuItem("微信小游戏/调试/BuildDirectories")]
        public static void BuildDirectoriesProcess() {
            BuildDirectories(false);
        }


        private static void BuildDirectories(bool exist) {
        ...
        private static void BuildBuildDirectory(bool exist) {
        ...
        private static void BuildConfigsDirectory(bool exist) {
        ...
        private static void BuildReferencesDirectory(bool exist) {
        ...
        private static void BuildDependencyDirectory(bool exist) {
